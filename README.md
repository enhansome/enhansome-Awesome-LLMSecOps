...
| [Opik](https://github.com/comet-ml/opik) ⭐ 21,406 \| 🐛 195 \| 🌐 Python \| 📅 2026-08-14                              | Open-source platform for LLM observability, evaluations, and prompt optimization.                                                                                                                       |
...
| [ai-evaluation by Future AGI](https://github.com/future-agi/ai-evaluation) ⭐ 117 \| 🐛 8 \| 🌐 Python \| 📅 2026-08-15 | Open-source LLM evaluation framework with 50+ metrics, LLM-as-Judge augmentation, and guardrail scanners (jailbreak, PII, prompt-injection); AutoEval pipelines with CI/CD support.                     |
| [Future AGI](https://github.com/future-agi/future-agi) ⭐ 1,686 \| 🐛 666 \| 🌐 Python \| 📅 2026-08-15                 | Open-source self-hostable end-to-end agent engineering and optimization platform unifying tracing, evaluation, simulation, datasets, gateway, and guardrails in one feedback loop.                      |
...
| Tool                                                                                        | Description                                  |
| ------------------------------------------------------------------------------------------- | -------------------------------------------- |
| [MarkLLM](https://github.com/THU-BPM/MarkLLM) ⭐ 1,030 \| 🐛 1 \| 🌐 Python \| 📅 2026-07-10 | An Open-Source Toolkit for LLM Watermarking. |
...
| [L1B3RT45](https://github.com/elder-plinius/L1B3RT45/) ⭐ 20,970 \| 🐛 76 \| 📅 2026-02-17                    | GitHub repository containing information and tools related to AI jailbreaking                                                                                                                                                                                                                         | ![GitHub stars](https://img.shields.io/github/stars/elder-plinius/L1B3RT45?style=social)            |
...
| [EasyJailbreak](https://github.com/EasyJailbreak/EasyJailbreak) ⭐ 885 \| 🐛 19 \| 🌐 Python \| 📅 2026-03-30 | An easy-to-use Python framework to generate adversarial jailbreak prompts                                                                                                                                                                                                                             | ![GitHub stars](https://img.shields.io/github/stars/EasyJailbreak/EasyJailbreak?style=social)       |
...
| [Awesome Jailbreak on LLMs - RAG Attacks](https://github.com/yueliu1999/Awesome-Jailbreak-on-LLMs?tab=readme-ov-file#attack-on-rag-based-llm) ⭐ 1,582 \| 🐛 0 \| 📅 2026-08-10               | Collection of RAG-based LLM attack techniques                         |
...
| [Agent Memory Guard](https://github.com/OWASP/www-project-agent-memory-guard) ⭐ 125 \| 🐛 26 \| 🌐 Python \| 📅 2026-08-16                    | Official OWASP runtime defense layer that screens every read/write to AI agent memory, blocking prompt injection, secret leakage, and memory poisoning (ASI06). Integrations for LangChain, LlamaIndex, CrewAI, AutoGen.                                                                                                                                                                                                                                  | ![GitHub stars](https://img.shields.io/github/stars/OWASP/www-project-agent-memory-guard?style=social)     |
...
| [LLMVault](https://github.com/CyberSunil/LLMVault) ⭐ 294 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-10                                                                                                      | Open-source CTF-style LLM security lab for learning the OWASP LLM Top 10 vulnerabilities                                                                                                                                                                                                                     |         |
...
| [Jailbreak LLMs](https://github.com/verazuo/jailbreak_llms/tree/main/data) ⭐ 3,779 \| 🐛 4 \| 🌐 Jupyter Notebook \| 📅 2024-12-24                  | Data for jailbreaking Large Language Models                                                                                                                                                                                                                                        |                                                                                             |
| [ChatGPT System Prompt](https://github.com/LouisShark/chatgpt_system_prompt) ⭐ 10,726 \| 🐛 1 \| 🌐 HTML \| 📅 2026-08-14                           | Repository containing ChatGPT system prompts                                                                                                                                                                                                                                       |                                                                                             |
...
|                       [Awesome LLM Security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,682 \| 🐛 182 \| 📅 2025-08-20                       | GitHub repository                                                                                                                                                                                                                                  |                                                                                                           |
...
|                [awesome-agent-runtime-security](https://github.com/bureado/awesome-agent-runtime-security) ⭐ 101 \| 🐛 9 \| 📅 2026-08-12               | An imperfect, incomplete collection of projects proving the integrity of tools, tool descriptions, models, data sources, and provenance by combining isolation, sandboxing, security observability, and server-constrained or client-bound tokens. | ![Github\_stars](https://img.shields.io/github/stars/bureado/awesome-agent-runtime-security?style=social) |
