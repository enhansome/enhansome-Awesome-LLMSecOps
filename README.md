...
| [Opik](https://github.com/comet-ml/opik) ⭐ 21,560 \| 🐛 228 \| 🌐 Python \| 📅 2026-08-24                               | Open-source platform for LLM observability, evaluations, and prompt optimization.                                                                                                                       |
...
| [Future AGI](https://github.com/future-agi/future-agi) ⭐ 1,796 \| 🐛 748 \| 🌐 Python \| 📅 2026-08-23                  | Open-source self-hostable end-to-end agent engineering and optimization platform unifying tracing, evaluation, simulation, datasets, gateway, and guardrails in one feedback loop.                      |
...
| Tool                                                                                        | Description                                  |
| ------------------------------------------------------------------------------------------- | -------------------------------------------- |
| [MarkLLM](https://github.com/THU-BPM/MarkLLM) ⭐ 1,051 \| 🐛 3 \| 🌐 Python \| 📅 2026-07-10 | An Open-Source Toolkit for LLM Watermarking. |
...
| [L1B3RT45](https://github.com/elder-plinius/L1B3RT45/) ⭐ 21,119 \| 🐛 76 \| 📅 2026-02-17                    | GitHub repository containing information and tools related to AI jailbreaking                                                                                                                                                                                                                         | ![GitHub stars](https://img.shields.io/github/stars/elder-plinius/L1B3RT45?style=social)            |
...
| [PoisonedRAG](https://github.com/sleeepeer/PoisonedRAG) ⭐ 296 \| 🐛 3 \| 🌐 Python \| 📅 2026-01-27                                                                                          | GitHub repository about poisoned RAG systems                          |
...
| [Awesome Jailbreak on LLMs - RAG Attacks](https://github.com/yueliu1999/Awesome-Jailbreak-on-LLMs?tab=readme-ov-file#attack-on-rag-based-llm) ⭐ 1,599 \| 🐛 0 \| 📅 2026-08-10               | Collection of RAG-based LLM attack techniques                         |
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [invariant](https://github.com/invariantlabs-ai/invariant) ⭐ 446 \| 🐛 10 \| 🌐 Python \| 📅 2026-01-12                                       | A trace analysis tool for AI agents.                                                                                                                                                                                                                                                                                                                                                                                                                      | ![GitHub stars](https://img.shields.io/github/stars/invariantlabs-ai/invariant?style=social)               |
...
| [Tenuo](https://github.com/tenuo-ai/tenuo) ⭐ 85 \| 🐛 12 \| 🌐 Rust \| 📅 2026-08-19                                                          | Capability-based authorization framework for AI agents. Task-scoped warrants with cryptographic attenuation, PoP binding, offline verification. LangChain/LangGraph/MCP integrations.                                                                                                                                                                                                                                                                     | ![GitHub stars](https://img.shields.io/github/stars/tenuo-ai/tenuo?style=social)                           |
...
| [LLMVault](https://github.com/CyberSunil/LLMVault) ⭐ 299 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-10                                                                                                      | Open-source CTF-style LLM security lab for learning the OWASP LLM Top 10 vulnerabilities                                                                                                                                                                                                                     |         |
...
| [Jailbreak LLMs](https://github.com/verazuo/jailbreak_llms/tree/main/data) ⭐ 3,792 \| 🐛 4 \| 🌐 Jupyter Notebook \| 📅 2024-12-24                  | Data for jailbreaking Large Language Models                                                                                                                                                                                                                                        |                                                                                             |
...
|                       [Awesome LLM Security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,685 \| 🐛 196 \| 📅 2025-08-20                       | GitHub repository                                                                                                                                                                                                                                  |                                                                                                           |
...
| [Agent Security Bench (ASB)](https://github.com/agiresearch/ASB) ⭐ 288 \| 🐛 4 \| 🌐 Python \| 📅 2026-04-16                                                                                                                                                                                                         | Benchmark for agent security                                                                                                                                                                                                                                        | ![GitHub stars](https://img.shields.io/github/stars/agiresearch/ASB?style=social)                                          |
