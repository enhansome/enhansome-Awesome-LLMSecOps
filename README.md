...
| [Opik](https://github.com/comet-ml/opik) ⭐ 21,581 \| 🐛 214 \| 🌐 Python \| 📅 2026-08-24                               | Open-source platform for LLM observability, evaluations, and prompt optimization.                                                                                                                       |
...
| [ai-evaluation by Future AGI](https://github.com/future-agi/ai-evaluation) ⭐ 117 \| 🐛 11 \| 🌐 Python \| 📅 2026-08-24 | Open-source LLM evaluation framework with 50+ metrics, LLM-as-Judge augmentation, and guardrail scanners (jailbreak, PII, prompt-injection); AutoEval pipelines with CI/CD support.                     |
| [Future AGI](https://github.com/future-agi/future-agi) ⭐ 1,806 \| 🐛 749 \| 🌐 Python \| 📅 2026-08-24                  | Open-source self-hostable end-to-end agent engineering and optimization platform unifying tracing, evaluation, simulation, datasets, gateway, and guardrails in one feedback loop.                      |
...
| [L1B3RT45](https://github.com/elder-plinius/L1B3RT45/) ⭐ 21,145 \| 🐛 76 \| 📅 2026-02-17                    | GitHub repository containing information and tools related to AI jailbreaking                                                                                                                                                                                                                         | ![GitHub stars](https://img.shields.io/github/stars/elder-plinius/L1B3RT45?style=social)            |
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [invariant](https://github.com/invariantlabs-ai/invariant) ⭐ 449 \| 🐛 10 \| 🌐 Python \| 📅 2026-01-12                                       | A trace analysis tool for AI agents.                                                                                                                                                                                                                                                                                                                                                                                                                      | ![GitHub stars](https://img.shields.io/github/stars/invariantlabs-ai/invariant?style=social)               |
