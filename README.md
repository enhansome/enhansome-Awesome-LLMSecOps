...
| [Opik](https://github.com/comet-ml/opik) ⭐ 21,977 \| 🐛 249 \| 🌐 Python \| 📅 2026-09-13                               | Open-source platform for LLM observability, evaluations, and prompt optimization.                                                                                                                       |
...
| [ai-evaluation by Future AGI](https://github.com/future-agi/ai-evaluation) ⭐ 119 \| 🐛 16 \| 🌐 Python \| 📅 2026-09-12 | Open-source LLM evaluation framework with 50+ metrics, LLM-as-Judge augmentation, and guardrail scanners (jailbreak, PII, prompt-injection); AutoEval pipelines with CI/CD support.                     |
| [Future AGI](https://github.com/future-agi/future-agi) ⭐ 1,987 \| 🐛 880 \| 🌐 Python \| 📅 2026-09-13                  | Open-source self-hostable end-to-end agent engineering and optimization platform unifying tracing, evaluation, simulation, datasets, gateway, and guardrails in one feedback loop.                      |
...
| Tool                                                                                        | Description                                  |
| ------------------------------------------------------------------------------------------- | -------------------------------------------- |
| [MarkLLM](https://github.com/THU-BPM/MarkLLM) ⭐ 1,070 \| 🐛 0 \| 🌐 Python \| 📅 2026-09-05 | An Open-Source Toolkit for LLM Watermarking. |
...
| [L1B3RT45](https://github.com/elder-plinius/L1B3RT45/) ⭐ 21,424 \| 🐛 76 \| 📅 2026-02-17                    | GitHub repository containing information and tools related to AI jailbreaking                                                                                                                                                                                                                         | ![GitHub stars](https://img.shields.io/github/stars/elder-plinius/L1B3RT45?style=social)            |
...
| [Awesome Jailbreak on LLMs - RAG Attacks](https://github.com/yueliu1999/Awesome-Jailbreak-on-LLMs?tab=readme-ov-file#attack-on-rag-based-llm) ⭐ 1,625 \| 🐛 0 \| 📅 2026-08-10               | Collection of RAG-based LLM attack techniques                         |
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [invariant](https://github.com/invariantlabs-ai/invariant) ⭐ 454 \| 🐛 13 \| 🌐 Python \| 📅 2026-01-12                                       | A trace analysis tool for AI agents.                                                                                                                                                                                                                                                                                                                                                                                                                      | ![GitHub stars](https://img.shields.io/github/stars/invariantlabs-ai/invariant?style=social)               |
| [Sunglasses](https://github.com/sunglasses-dev/sunglasses) ⭐ 5 \| 🐛 8 \| 🌐 Python \| 📅 2026-09-13                                          | Runtime trust scanner for AI agents: 1,089 patterns across 65 attack categories (prompt injection, tool poisoning, MCP attacks) plus a mechanism layer. Pip package, GitHub Action, free web scan, published precision/recall benchmark.                                                                                                                                                                                                                  | ![GitHub stars](https://img.shields.io/github/stars/sunglasses-dev/sunglasses?style=social)                |
| [Nika](https://github.com/supernovae-st/nika) ⭐ 76 \| 🐛 40 \| 🌐 Rust \| 📅 2026-09-13                                                       | Open-source Rust workflow engine for AI agents with security in the runtime: default-deny permits (fs/net/exec/tool allowlists), static secret-flow analysis before any run, cost floors, tamper-evident hash-chained traces verifiable via nika trace verify, read-only MCP oracle.                                                                                                                                                                      | ![GitHub stars](https://img.shields.io/github/stars/supernovae-st/nika?style=social)                       |
| [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,727 \| 🐛 77 \| 🌐 Python \| 📅 2026-02-08                                              | A Comprehensive Benchmark to Evaluate LLMs as Agents (ICLR'24)                                                                                                                                                                                                                                                                                                                                                                                            | ![GitHub stars](https://img.shields.io/github/stars/THUDM/AgentBench?style=social)                         |
...
| [Awesome MCP Security](https://github.com/Puliczek/awesome-mcp-security) ⭐ 734 \| 🐛 204 \| 📅 2026-03-03                                     | Curated list of MCP security resources                                                                                                                                                                                                                                                                                                                                                                                                                    | ![GitHub stars](https://img.shields.io/github/stars/Puliczek/awesome-mcp-security?style=social)            |
...
| [Tenuo](https://github.com/tenuo-ai/tenuo) ⭐ 91 \| 🐛 91 \| 🌐 Rust \| 📅 2026-09-12                                                          | Capability-based authorization framework for AI agents. Task-scoped warrants with cryptographic attenuation, PoP binding, offline verification. LangChain/LangGraph/MCP integrations.                                                                                                                                                                                                                                                                     | ![GitHub stars](https://img.shields.io/github/stars/tenuo-ai/tenuo?style=social)                           |
...
| [TealTiger](https://github.com/agentguard-ai/tealtiger) ⭐ 32 \| 🐛 54 \| 🌐 TypeScript \| 📅 2026-09-11                                       | Deterministic governance engine for AI agents — policy enforcement, tool allowlisting, memory governance, cost tracking, and structured audit evidence (SARIF, JUnit XML, JSON). Docker sidecar for any language.                                                                                                                                                                                                                                         | ![GitHub stars](https://img.shields.io/github/stars/agentguard-ai/tealtiger?style=social)                  |
...
| [Agent Memory Guard](https://github.com/OWASP/www-project-agent-memory-guard) ⭐ 173 \| 🐛 22 \| 🌐 Python \| 📅 2026-09-13                    | Official OWASP runtime defense layer that screens every read/write to AI agent memory, blocking prompt injection, secret leakage, and memory poisoning (ASI06). Integrations for LangChain, LlamaIndex, CrewAI, AutoGen.                                                                                                                                                                                                                                  | ![GitHub stars](https://img.shields.io/github/stars/OWASP/www-project-agent-memory-guard?style=social)     |
...
| [LEASH-8](https://github.com/Palo-Alto-AI-Research-Lab/agent-leash) ⭐ 2 \| 🐛 0 \| 📅 2026-09-10                                              | Control model for agents holding delegated authority, across eight domains: identity, secrets, tool/skill supply chain, approvals, containment, egress, observability, incident response. Ships a 24-statement scored self-assessment, the plan-vs-authorize gate pattern (model plans, policy decides, executor acts), an approval-design checklist for irreversible actions, and a reference A2A Agent Card. Docs and templates — no runtime component. | ![GitHub stars](https://img.shields.io/github/stars/Palo-Alto-AI-Research-Lab/agent-leash?style=social)    |
...
| [🛡️ Agent Browser Shield](https://github.com/pixiebrix/agent-browser-shield) ⭐ 35 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-09-12                                                                     | Open-source safety layer between browser-use AI agents and the web pages they visit. Masks PII/secrets, blocks prompt injection in invisible text and HTML comments, and strips dark patterns and noise. Chromium MV3 extension, also on Browserbase and ClawHub. | PixieBrix          |
...
| [FigStep](https://github.com/ThuCCSLab/FigStep) ⭐ 215 \| 🐛 2 \| 🌐 Python \| 📅 2025-06-26                                                                        | Jailbreaking Large Vision-language Models via Typographic Visual Prompts                                                                                  | ![GitHub stars](https://img.shields.io/github/stars/ThuCCSLab/FigStep?style=social)                                                   |
...
| [OWASP Agentic AI](https://github.com/precize/OWASP-Agentic-AI/) ⭐ 201 \| 🐛 1 \| 📅 2026-06-02                                                                    | OWASP Top 10 for Agentic AI (AI Agent Security) - Pre-release version                                                                                     | ![GitHub stars](https://img.shields.io/github/stars/precize/OWASP-Agentic-AI?style=social)                                            |
...
| [LLMVault](https://github.com/CyberSunil/LLMVault) ⭐ 312 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-10                                                                                                      | Open-source CTF-style LLM security lab for learning the OWASP LLM Top 10 vulnerabilities                                                                                                                                                                                                                     |         |
...
| [Damn Vulnerable LLM Agent](https://github.com/WithSecureLabs/damn-vulnerable-llm-agent) ⭐ 514 \| 🐛 4 \| 🌐 Python \| 📅 2025-06-25                                                                | Intentionally vulnerable LLM agent for security testing and education                                                                                                                                                                                                                                        |         |
...
| [Jailbreak LLMs](https://github.com/verazuo/jailbreak_llms/tree/main/data) ⭐ 3,812 \| 🐛 4 \| 🌐 Jupyter Notebook \| 📅 2024-12-24                  | Data for jailbreaking Large Language Models                                                                                                                                                                                                                                        |                                                                                             |
| [ChatGPT System Prompt](https://github.com/LouisShark/chatgpt_system_prompt) ⭐ 10,760 \| 🐛 1 \| 🌐 HTML \| 📅 2026-09-11                           | Repository containing ChatGPT system prompts                                                                                                                                                                                                                                       |                                                                                             |
...
|                       [Awesome LLM Security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,694 \| 🐛 218 \| 📅 2025-08-20                       | GitHub repository                                                                                                                                                                                                                                  |                                                                                                           |
...
|               [Arcanum Prompt Injection Taxonomy](https://github.com/Arcanum-Sec/arc_pi_taxonomy/tree/main) ⭐ 760 \| 🐛 1 \| 📅 2026-06-29              | Structured taxonomy of prompt injection attacks categorizing attack intents, techniques, and evasions. Resource for security researchers, AI developers, and red teamers.                                                                          | ![GitHub stars](https://img.shields.io/github/stars/Arcanum-Sec/arc_pi_taxonomy?style=social)             |
|               [awesome-agent-runtime-security](https://github.com/bureado/awesome-agent-runtime-security) ⭐ 111 \| 🐛 26 \| 📅 2026-09-07               | An imperfect, incomplete collection of projects proving the integrity of tools, tool descriptions, models, data sources, and provenance by combining isolation, sandboxing, security observability, and server-constrained or client-bound tokens. | ![Github\_stars](https://img.shields.io/github/stars/bureado/awesome-agent-runtime-security?style=social) |
...
| [Agent Security Bench (ASB)](https://github.com/agiresearch/ASB) ⭐ 299 \| 🐛 4 \| 🌐 Python \| 📅 2026-04-16                                                                                                                                                                                                         | Benchmark for agent security                                                                                                                                                                                                                                        | ![GitHub stars](https://img.shields.io/github/stars/agiresearch/ASB?style=social)                                          |
